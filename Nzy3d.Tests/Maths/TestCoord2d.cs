...
namespace Nzy3d.Tests.Maths
{
    public class TestCoord2d
    {
        ...
        public void EqualsTests()
        {
            ...
            Assert.True(new Coord2d(1, 2) == new Coord2d(1, 2));
            Assert.False(new Coord2d(1, 2) != new Coord2d(1, 2));
            ...
            Assert.False(new Coord2d(1, 2) == new Coord2d(2, 1));
            Assert.True(new Coord2d(1, 2) != new Coord2d(2, 1));
            ...
            Assert.True(new Coord2d(-0, 2) == new Coord2d(0, 2));
            Assert.False(new Coord2d(-0, 2) != new Coord2d(0, 2));
            ...
            Assert.True(new Coord2d(float.NaN, 2) == new Coord2d(float.NaN, 2));
            Assert.False(new Coord2d(float.NaN, 2) != new Coord2d(float.NaN, 2));
            ...
            Assert.True(new Coord2d(float.PositiveInfinity, 2) == new Coord2d(float.PositiveInfinity, 2));
            Assert.False(new Coord2d(float.PositiveInfinity, 2) != new Coord2d(float.PositiveInfinity, 2));
            ...
            Assert.True(new Coord2d(float.NegativeInfinity, 2) == new Coord2d(float.NegativeInfinity, 2));
            Assert.False(new Coord2d(float.NegativeInfinity, 2) != new Coord2d(float.NegativeInfinity, 2));
            ...
            Assert.False(new Coord2d(float.PositiveInfinity, 2) == new Coord2d(float.NegativeInfinity, 2));
            Assert.True(new Coord2d(float.PositiveInfinity, 2) != new Coord2d(float.NegativeInfinity, 2));
        }
    }
}
